...
<p align="center">
  <img src="docs/images/imessage-approval.svg" alt="An iMessage thread: the user asks to delete a reminder; Honeycrisp acknowledges, then replies with an approval request naming the reminder, its list, and its due date, asking the user to reply &quot;yes a3f9c1&quot;; the user replies with the code; Honeycrisp confirms the deletion with the same details." width="430">
</p>
