...
Honeycrisp: Received — working on it…
Honeycrisp: Added "Call vet" for tomorrow, Aug 3 at 2:00 PM.
```
...
Honeycrisp: Three emails from Lincoln Elementary. Two are the weekly
...
```
You:       Delete the "call the vet" reminder
Honeycrisp: Approval needed: reminder_delete
            Would permanently DELETE "call the vet" from the Home list,
            due Sunday at 2:00 PM.
            Reply "yes a3f9c1" to run it, "no a3f9c1" to refuse.
            No reply in 5 min = refused.
You:       yes a3f9c1
Honeycrisp: Deleted "call the vet", which was due Sunday at 2:00 PM.
```
...
approval. Ignore the message and nothing happens.
...
```
You:       what can you do?
Honeycrisp: Here's what I can do with your Mac:
...
Honeycrisp inverts the default. A tool call *previews* what it would do unless
...
|---|---|
| [`@honeycrisp/governed`](https://www.npmjs.com/package/@honeycrisp/governed) | The framework: dry-run defaults, approval gates, audit, provenance, undo, injection fencing. Build your own governed tools on it. |
| [`@honeycrisp/mail`](https://www.npmjs.com/package/@honeycrisp/mail) | Apple Mail: read, search (two tiers), threads, drafts. Draft-first — no send tool exists. |
| [`@honeycrisp/reminders`](https://www.npmjs.com/package/@honeycrisp/reminders) | Reminders: lists, search, create, complete, delete — with native undo. |
| [`@honeycrisp/notes`](https://www.npmjs.com/package/@honeycrisp/notes) | Notes: folders, search, read, create, append. |
| [`@honeycrisp/calendar`](https://www.npmjs.com/package/@honeycrisp/calendar) | Calendar: window queries, create, delete. Cannot send invitations, by design. |
| [`@honeycrisp/context`](https://www.npmjs.com/package/@honeycrisp/context) | Local context layer: mail/calendar *metadata* (pointers, never bodies), briefings, person lookups, a corrections flywheel. |
| [`@honeycrisp/imessage`](https://www.npmjs.com/package/@honeycrisp/imessage) | Text your own AI. Owner-only by construction, approvals by reply. |
| [`@honeycrisp/folders`](https://www.npmjs.com/package/@honeycrisp/folders) | Folder-as-API: drop a file in iCloud from any device, a declared local pipeline runs. |
| [`@honeycrisp/remote`](https://www.npmjs.com/package/@honeycrisp/remote) | Reach the suite from your other devices over your own private network. |
| [`@honeycrisp/setup`](https://www.npmjs.com/package/@honeycrisp/setup) | The onboarding wizard. |
